...
class __TwigTemplate_338106400cea331e7b27a097aebdec83df4a13c5db489ebf7c1ab6e744a65a59 extends Twig_SupTwg_Template
{
...
(isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "Actions"), "method"));
        ...
        $context['_seq'] = Twig_SupTwg_ensure_traversable((isset($context["columns"]) ? $context["columns"] : null));
        ...
        // line 41
        $context['_parent'] = $context;
        $context['_seq'] = Twig_SupTwg_ensure_traversable((isset($context["galleries"]) ? $context["galleries"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["gallery"]) {
            ...
            echo "
                            ...
                            <td>
                                <a href=\"";
            // line 50
            echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "generateUrl", array(0 => "galleries", 1 => "settings", 2 => array("gallery_id" => $this->getAttribute($context["gallery"], "id", array()))), "method"), "html", null, true);
            echo "\" data-toggle=\"tooltip\" title=\"";
            echo Twig_SupTwg_escape_filter($this->env, sprintf($this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "Edit gallery \"%s\""), "method"), $this->getAttribute($context["gallery"], "title", array())), "html", null, true);
            echo "\">
                                    ";
            // line 51
            ...
            echo "
                                ";
            // line 62
            if ((Twig_SupTwg_length_filter($this->env, (isset($context["cover"]) ? $context["cover"] : null)) < 1)) {
                // line 63
                echo "                                    ";
            ...
            echo "                                <div style=\"width:155px;height:100px;overflow:hidden;\">
                                    <img src=\"";
            // line 68
            echo Twig_SupTwg_escape_filter($this->env, ((array_key_exists("cover", $context)) ? (_Twig_SupTwg_default_filter((isset($context["cover"]) ? $context["cover"] : null), ("holder.js/350x220?theme=gray&text=" . $this->getAttribute($context["gallery"], "title", array())))) : (("holder.js/350x220?theme=gray&text=" . $this->getAttribute($context["gallery"], "title", array())))), "html", null, true);
            echo "\" alt=\"";
            ...
            echo "
                                ...
                                <a href=\"";
            // line 84
            echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "generateUrl", array(0 => "galleries", 1 => "view", 2 => array("gallery_id" => $this->getAttribute($context["gallery"], "id", array()))), "method"), "html", null, true);
            echo "\"
                                   class=\"button background sggActionButtons\">
            ...
            echo "
                                ...
                                <a href=\"";
            // line 89
            echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "generateUrl", array(0 => "galleries", 1 => "preview", 2 => array("gallery_id" => $this->getAttribute($context["gallery"], "id", array()))), "method"), "html", null, true);
            echo "\"
                                   class=\"button background sggActionButtons\">
                                    <i class=\"fa fa-eye\"></i>
                                    ";
            ...
            echo "\" class=\"button button-primary sggActionButtons\" title=\"Delete this gallery\"
                                   href=\"";
            // line 101
            echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "generateUrl", array(0 => "galleries", 1 => "delete", 2 => array("gallery_id" => $this->getAttribute($context["gallery"], "id", array()), "_wpnonce" => (isset($context["_wpnonce"]) ? $context["_wpnonce"] : null))), "method"), "html", null, true);
            echo "\">
        ...
        // line 120
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "Delete selected"), "method"), "html", null, true);
        echo "
                </button>
            </div>
        </div>
...
";
    ...
    public function getputPreset($__data__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            echo "\"
             data-preset=\"";
            // line 128
            echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "value", array()), "html", null, true);
            echo "\">
            <p>";
            // line 129
            echo Twig_SupTwg_escape_filter($this->env, Twig_SupTwg_title_string_filter($this->env, $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "title", array())), "html", null, true);
            echo "</p>
            <img src=\"";
            // line 130
            echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "getModule", array(0 => "galleries"), "method"), "getLocationUrl", array(), "method"), "html", null, true);
            echo "/assets/img/";
            echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "image", array()), "html", null, true);
            echo "\" alt=\"\"/>
            ";
            // line 131
    ...
    {
        return new Twig_SupTwg_Source("", "@galleries/index.twig", "/home/dannytua/kaodesign.vn.2020/wp-content/plugins/gallery-by-supsystic/src/GridGallery/Galleries/views/index.twig");
    }
}
