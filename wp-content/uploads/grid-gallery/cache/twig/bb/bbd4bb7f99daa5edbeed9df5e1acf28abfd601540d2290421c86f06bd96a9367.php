...
class __TwigTemplate_5f4428bfbab9d5b38ec11618ba1d2f1cc3c64cdfe949c7e029c240ecfe6a94f1 extends Twig_SupTwg_Template
{
...
\t";
            // line 18
            echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('get_attachment')->getCallable(), array((isset($context["attachmentId"]) ? $context["attachmentId"] : null), (isset($context["width"]) ? $context["width"] : null), (isset($context["height"]) ? $context["height"] : null), (isset($context["crop"]) ? $context["crop"] : null))), "html", null, true);
            echo "
";
        } catch (Exception $e) {
            ob_end_clean();
    ...
    {
        return new Twig_SupTwg_Source("", "@galleries/helpers/attachment.twig", "/home/dannytua/kaodesign.vn.2020/wp-content/plugins/gallery-by-supsystic/src/GridGallery/Galleries/views/helpers/attachment.twig");
    }
}
