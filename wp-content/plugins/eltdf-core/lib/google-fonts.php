<?php
if ( ! function_exists( 'ambient_elated_init_google_fonts_array' ) ) {
    function ambient_elated_init_google_fonts_array() {

        global $ambient_elated_global_fonts_array;
        $ambient_elated_global_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'ambient_elated_init_google_fonts_array');
}