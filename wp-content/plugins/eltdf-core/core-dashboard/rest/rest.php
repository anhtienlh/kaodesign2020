...
if ( ! class_exists( 'AmbientCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class AmbientCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'ambient-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'ambient_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	AmbientCoreDashboardRestAPI::get_instance();
}