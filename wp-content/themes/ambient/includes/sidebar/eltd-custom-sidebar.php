...
if( ! class_exists('AmbientElatedClassSidebar') ){
	...
	class AmbientElatedClassSidebar{
		...
		function load_assets(){
			...
			wp_enqueue_script('ambient-elated-sidebar' , ELATED_ROOT . '/framework/admin/assets/js/eltdf-sidebar.js');
			wp_enqueue_style( 'ambient-elated-sidebar' , ELATED_ROOT . '/framework/admin/assets/css/eltdf-sidebar.css');
		}
