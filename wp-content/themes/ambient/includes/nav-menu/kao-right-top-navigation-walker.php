...
if (!class_exists('AmbientElatedClassKaoRightTopNavigationWalker')) {
	class AmbientElatedClassKaoRightTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			// kien-dx
			if(strpos($class_names, 'kao-header-right-menu') === false) {
				return;
			}
			// build html
