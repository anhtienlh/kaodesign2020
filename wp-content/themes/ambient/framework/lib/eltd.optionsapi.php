 ...
 */
if(!function_exists('ambient_elated_create_meta_box')) {
    /**
     * Adds new meta box
     *
     * @param $attributes
     ...
     */
    function ambient_elated_create_meta_box($attributes) {
        $scope = array();
        $title = '';
        $hidden_property = '';
        $hidden_values = array();
...
if(!function_exists('ambient_elated_create_meta_box_field')) {
    /**
     ...
     * @return bool|AmbientElatedClassField
     */
    function ambient_elated_create_meta_box_field($attributes) {
        $type            = '';
        $name            = '';
        $default_value   = '';
        $label           = '';
