...
class AmbientElatedClassIconCollections {
    ...
    public function getSearchIcon($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo ambient_elated_get_module_part( $iconsObject->getSearchIcon() );
            }
        }
    }
    ...
    public function getSearchClose($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo ambient_elated_get_module_part( $iconsObject->getSearchClose() );
            }
        }
    }
    ...
    public function getSearchIconValue($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo ambient_elated_get_module_part( $iconsObject->getSearchIconValue() );
        }
    }
    ...
    public function getMenuSideIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo ambient_elated_get_module_part( $iconsObject->getMenuSideIcon() );
        }
    }
    ...
    public function getBackToTopIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo ambient_elated_get_module_part( $iconsObject->getBackToTopIcon() );
        }
    }
    ...
    public function getMobileMenuIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo ambient_elated_get_module_part( $iconsObject->getMobileMenuIcon() );
            }
        }
    }
    ...
    public function getQuoteIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return == true) {
				...
				echo ambient_elated_get_module_part( $iconsObject->getQuoteIcon() );
            }
        }
    }
